...
class StudentResourceIT {
    ...
    void createStudent() throws Exception {
        ...
        assertThat(testStudent.getBirthOfDay()).isEqualTo(DEFAULT_BIRTH_OF_DAY);
    ...
    @Test
    @Transactional
    void checkBirthOfDayIsRequired() throws Exception {
        int databaseSizeBeforeTest = studentRepository.findAll().size();
        // set the field null
        student.setBirthOfDay(null);
    ...
    void putNewStudent() throws Exception {
        ...
        assertThat(testStudent.getBirthOfDay()).isEqualTo(UPDATED_BIRTH_OF_DAY);
    ...
    void partialUpdateStudentWithPatch() throws Exception {
        ...
        partialUpdatedStudent.age(UPDATED_AGE).birthOfDay(UPDATED_BIRTH_OF_DAY).phoneNumber(UPDATED_PHONE_NUMBER);
